...
function updateCountdown() {
    ...
    var absoluteTimeRemaining = Math.abs(timeRemaining);  

    var days = Math.floor(absoluteTimeRemaining / (1000 * 60 * 60 * 24));
    var hours = Math.floor((absoluteTimeRemaining % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    var minutes = Math.floor((absoluteTimeRemaining % (1000 * 60 * 60)) / (1000 * 60));
    var seconds = Math.floor((absoluteTimeRemaining % (1000 * 60)) / 1000);
